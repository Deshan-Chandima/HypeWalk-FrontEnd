...
export default function AddProductsAdminPage() {
  ...
  const [gender, setGender] = useState("Unisex"); // ✅ NEW STATE
      ...
      <div className="w-full max-w-[900px] mx-auto border border-gray-100 rounded-3xl p-8 bg-white shadow-xl flex flex-col gap-6">
        ...
        <div className="flex justify-center gap-4 pt-6">
          <button
            ...
            disabled={loading}
            className="cursor-pointer w-[200px] h-[50px] border-2 border-black rounded-md flex justify-center items-center bg-black text-white hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
